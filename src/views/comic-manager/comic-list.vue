<template>
  ...
  >
        ...
        <el-col :xl="16" :lg="16" :md="24" :sm="24" :xs="24">
          <div class="abilityBtn">
            ...
            <el-upload
              ...
              :http-request="importExcCartoon"
            >
              <el-button type="primary" icon="Bottom">批量导入漫画</el-button>
            </el-upload>
            <el-upload
              style="margin-left: 12px"
              action="#"
    ...
    <template #charge="{ scope }">
      <el-tag
        :type="scope.row.charge === 0 ? 'danger' : 'success'"
        effect="dark"
      >
...
// (批量)导入excel并上传漫画
const importExcCartoon = async (options: UploadRequestOptions) => {
  state.logform.data = ''
  try {
