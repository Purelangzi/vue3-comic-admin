        ...
        <el-col :xl="16" :lg="16" :md="24" :sm="24" :xs="24">
          <div class="abilityBtn">
            ...
            <!-- <el-upload
              ...
              :http-request="importExcNovel"
              >
              <el-button type="primary" icon="Bottom" >批量导入小说</el-button>
            </el-upload> -->
            <el-upload
              style="margin-left: 12px"
              action="#"
...
// (批量)导入excel并上传小说
// const importExcNovel = async(options: UploadRequestOptions)=>{
//   state.logform.data = ''
//   try {
...
//     let head:any = {
//       小说名称: 'name',
//       小说简介: 'cartoon_introduction',
//       作者: 'author',
//       价格: 'price',
//       是否vip: 'is_vip',
//       封面: 'img_url',
//       上家小说ID: 'platform_comic',
//       小说详情封面: 'cover_lateral'
//     }
...
//     state.logform.data = `开始导入小说\n`
//     // forEach里的await是并行的
//     for (let i = 0; i < list.length; i++) {
//       const item = list[i]
//       item.category_id = state.categoryData[0].id
//       const res = await addList(item)
//       if(res.code == 200){
//         state.logform.data = `${i+1}/${listLength}\n`+state.logform.data
//       }else{
//         state.logform.data = `${i+1}/${listLength},${res.msg}\n`+state.logform.data
//       }
//     }
